    ...
    <div className="col-12 col-md-3 mb-4">
      <div className="card bg-dark">
        ...
        <div className="card-body">
          <h4 className="card-title text-center"><Link to={`/course/${props.course.title}/${props.course.id}`} style={{ fontFamily: 'ADLaM Display', color: 'white', textDecoration: 'none' }}>{props.course.title}</Link></h4>
