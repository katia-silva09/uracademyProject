    ...
    <div className="col-12 col-md-3 mb-4">
      <div className="card">
        ...
        <div className="card-body">
          <h4 className="card-title text-center"><Link to={`/course/${props.course.title}/${props.course.id}`} style={{ fontFamily: 'ADLaM Display', color: 'DarkSlateGray' }}>{props.course.title}</Link></h4>
          <h5 className="card-title text-muted text-center">Precio:{props.course.price} </h5>
