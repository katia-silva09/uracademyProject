                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <Link to={`/course/${item.course.id}`}>
                                                <img src={item.course.image} className="img-thumbnail" width='80' alt={item.course.title} />
                                            </Link>
                                            <p>
                                                <Link to={`/course/${item.course.id}`}>{item.course.title}</Link>
                                            </p>
                                        </td>
                                        ...
                                        <td>
                                            <button
                                                ...
                                                type="button"
                                                onClick={() => cartRemoveButtonHandler(item.course.id)}
