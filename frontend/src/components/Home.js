  ...
  return (
    <section style={{ backgroundColor: 'DarkSlateGray', marginTop: 0, paddingTop: 20, paddingBottom: 20 }}>
      <div className="container">
        ...
        <h3 className="mb-4" style={{ fontFamily: 'ADLaM Display', color: 'white' }}>
          Latest Course
          ...
          <div className="col-12 col-md-3 mb-2">
            <div className="card bg-dark">
              ...
              <div className="card-body">
                ...
                <div className="card-footer text-center text-white" style={{ fontFamily: 'ADLaM Display', color: 'white', fontSize: 20 }}>
                  Course download 2500
                </div>
              </div>
            </div>
          </div>
          {/* Category Box end */}
          {/* Repeat other category boxes as needed */}
        </div>
        {/* end categorias populares */}

        {/* best blogs */}
        <h3 className='mb-4' style={{ fontFamily: 'ADLaM Display', color: 'white', marginTop: 20 }}>
          Best Blogs
